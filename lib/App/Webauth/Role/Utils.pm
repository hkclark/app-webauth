package App::Webauth::Role::Utils;
...
App::Webauth::Role::Utils - common utils for App::Webauth
...
=item $webauth->spawn_cmd(@cmd_with_options, [$spawn_cmd_options])
