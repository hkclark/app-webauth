...
App::Webauth::Role::I18N - utils for internationalization
...
sub choose_language {
    ...
    foreach my $item ( split( /,/, $http_accept_language ) ) {
        ...
        # don't use fine-granular language subtags for App-Webauth
